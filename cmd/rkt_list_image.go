...
var rktListImageCmd = &cobra.Command{
	Use:   "image",
	Short: "Run shell command with arguments in 'list' action on 'rkt list' mode",
	Long: `
Run shell command with arguments in 'list' action on 'rkt list' mode. For example:
