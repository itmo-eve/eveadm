...
eveadm rkt start ps x`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("rkt start called")
		run(Timeout, args)
	},
}
...
func init() {
	...
	// rktStartCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// rktStartCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
